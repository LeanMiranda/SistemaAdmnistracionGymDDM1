  ...
  const listItemView = (item) => {
    return (
      <View key={item.codigo} style={styles.listItemView}>
        <MyText text="Codigo" style={styles.text} />
        <MyText text={item.codigo} style={styles.text_data} />

        <MyText text="Tipo de maquina" style={styles.text} />
        <MyText text={item.tipomaquina} style={styles.text_data} />

        <MyText text="Numero de sala" style={styles.text} />
        <MyText text={item.nrosala} style={styles.text_data} />
